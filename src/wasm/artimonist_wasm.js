 ...
 * @returns {string}
 */
export function compress(content, compress) {
    let deferred2_0;
    let deferred2_1;
    try {
 ...
 * @returns {string}
 */
export function simple_init(values, salt) {
    let deferred3_0;
    let deferred3_1;
    try {
 ...
 * @returns {string}
 */
export function complex_init(values, salt) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passArrayJsValueToWasm0(values, wasm.__wbindgen_malloc);
 ...
 * @returns {string[]}
 */
export function generate(master, target, min, max) {
 ...
 * @returns {string}
 */
export function encrypt(content, encrypt) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(content, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('artimonist_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
